...
#define __GMP_CC "/bin/gcc -std=gnu99"
#define __GMP_CFLAGS "-O2 -I/work/ps2/mywork/buildroot/output/host/include -I/work/ps2/mywork/buildroot/output/host/usr/include"
